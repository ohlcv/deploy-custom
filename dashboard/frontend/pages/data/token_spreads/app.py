...
initialize_st_page(page_title=t("Token Spreads"), icon="🧙")
...
tokens = st.multiselect(t("Select the tokens to analyze:"), options=coins_df["name"], default=CONFIG.DEFAULT_MINER_COINS)
...
exchanges = st.multiselect(
    t("Select the exchanges to analyze:"),
...
fig = px.scatter(
    ...
    title=t("Spread and Volume Chart"),
    labels={
        "volume": t("Volume (USD)"),
        "bid_ask_spread_percentage": t("Bid Ask Spread (%)"),
